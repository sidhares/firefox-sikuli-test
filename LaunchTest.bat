...
set SIKULIPATH=C:\sikulix\sikulix-2.0.0.jar
...
java -cp %JYTHONJARPATH%;%SIKULIJARPATH%;%COMMONIOJARPATH%;%JNAPJARPATH%;%JNAJARPATH% org.python.util.jython Rowselectiontest.py
